...
export const AuthProvider = ({ children }) => {
	...
	// 👇 New: Get auth headers with token
	const getAuthHeader = () => {
	...
	// ✅ Updated: login with optional role (for role-specific endpoints or validation)
	const login = async (email, password, role = null) => {
		try {
			setError(null);
			// You can either:
			//   a) use same /login endpoint and infer role from JWT claim, OR
			//   b) use role-specific endpoints like /login/driver, /login/passenger
			// We'll use (a) — simpler, backend handles role in token.
